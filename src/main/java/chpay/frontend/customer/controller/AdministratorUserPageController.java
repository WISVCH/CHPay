...
@Controller
public class AdministratorUserPageController extends PageController {
  ...
  @Autowired
  protected AdministratorUserPageController(
  ...
  @GetMapping(value = "/admin/users/{userKey}")
  ...
  @PreAuthorize("hasRole('ADMIN')")
  @GetMapping(value = "/admin/users/{userKey}/stats/{type}")
  ...
  @Transactional
  @PreAuthorize("hasRole('ADMIN')")
  @PostMapping(value = "/admin/users/{id}/ban")
