...
@Controller
public class AdministratorTransactionsTablePageController extends PageController {
  ...
  @Autowired
  protected AdministratorTransactionsTablePageController(
      AdminTransactionServiceImpl adminTransactionService,
