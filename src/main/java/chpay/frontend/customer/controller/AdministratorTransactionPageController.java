...
@Controller
public class AdministratorTransactionPageController extends PageController {
  ...
  @Autowired
  protected AdministratorTransactionPageController(
  ...
  @GetMapping(value = "/admin/transactions/{tx}/refund")
  public String processRefund(
    ...
    return "redirect:/admin/transactions/" + refund.getId().toString();
  }
   ...
   */
  @PreAuthorize("hasRole('ADMIN')")
  @GetMapping(value = "/admin/transactions/{tx}")
